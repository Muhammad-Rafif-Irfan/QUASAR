...
def parse_payload(payload: dict) -> dict:
    ...
    parsed = {
        ...
        "max_circuit_depth": int(payload.get("max_circuit_depth", 10_000)),
        "max_energy_scale": int(payload.get("max_energy_scale", 1_000)),
        # IBM settings
    ...
    if backend_name:
        ...
        if backend.num_qubits < n_qubits:
            raise ValueError(
                ...
                f"but this circuit requires at least {n_qubits}."
            )
